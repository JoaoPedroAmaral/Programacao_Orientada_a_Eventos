...
largura_tela = 700
altura_tela = 640
# imagem_icon_1 = Image.open("../Processamento_de_imagens/icon_1.png")
...
class Funcoes():
    # Mostrar uma mensagem quando surgir um erro
    def mensagem_erro(self, e):
        self.sub_mensagem_de_erro(e)
        self.label = CTkLabel(self.sub_mensagem_erro, text=e, font=('Arial', 12), text_color="Salmon")
        self.label.place(relx=0.5, rely=0.5, anchor='center')
    # Abre uma janela para o usuario selecionar uma imagem
    def abrir_imagem(self):
        ...
        except PermissionError as ea:
            self.mensagem_erro("Imagem não carregada")
        except Exception as e:
            print(e)
            self.mensagem_erro(e)

    # Mostra a imagem carregada no frame
    ...
    def trocar_imagem(self, tipo = ""):
        try:
            ...
            self.mensagem_erro("Imagem não encontrada")
        except Exception as e:
            print(e)
            self.mensagem_erro(e)
...
class Procetimentos():
    ...
    def page_4(self):
        ...
        self.btn_3_page_4 = CTkButton(master=self.tabview.tab(" 4 "), text="Trocar", font=("arial", 12), width=50, height=25, command= lambda: self.trocar_imagem("CMYK"), 
                                      corner_radius=36, fg_color=cor_1, hover_color=cor_2)
...
class classe_principal(Procetimentos, Funcoes):
    ...
    def sub_mensagem_de_erro(self, e):
        self.sub_mensagem_erro = Toplevel(master=self.root)
        self.sub_mensagem_erro.title("__ERRO__")
        screen_width = root.winfo_screenwidth()
        screen_height = root.winfo_screenheight()
